...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para usted mi vida <3:\n\nDesde el primer momento supe que eras tú. Tu sonrisa, tu voz, tu forma de ser… todo en ti me hace sentir en casa.\n\nNo todo es perfecto, hemos tenido buenos y malos días, pero lo importante es que seguimos juntos. Y mientras estemos dispuestos a hablar, a entendernos y a abrazarnos después de cada tormenta, sé que podemos con todo.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con todo mi amorch, Giovaa <3 💗";
